...
tasks.jar {
    ...
    manifest {
        ...
        attributes(
            ...
            "Implementation-Title" to "PaperLive",
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "PaperLive",
            "Specification-Version" to project.version,
            "Specification-Vendor" to "PaperLive Team",
            "Brand-Id" to "paperlive:paperlive",
            "Brand-Name" to "PaperLive",
